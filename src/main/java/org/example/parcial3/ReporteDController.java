...
public class ReporteDController {
    ...
    public void setFacilitador() throws SQLException { //00377223 sirve para setear el choiceBox
        rs = st.executeQuery("SELECT nombre FROM FACILITADOR "); //00377223 selecciona los nombres de los facilitadores
        while (rs.next()) {//00377223 itera los nombres de los facilitadores
            cbFacilitador.getItems().add(rs.getString("nombre"));//00377223 los guarda en el choice box
        }
    }
